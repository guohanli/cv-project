...
# from api.vision_language import vision_language_ap# from api.face import face_api
from api.image_retrieval import image_retrieval_api
...
app.register_blueprint(image_retrieval_api)
